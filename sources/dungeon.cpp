...
void Dungeon::initMonsters() {
    ...
    monsters.push_back(new Monster("森林之王", 150, 80, 10, 5, nullptr, poisons[3]));
}
...
void Dungeon::initRooms() {
    ...
    rooms.push_back(new Swamp(4));
    rooms.push_back(new Forest(5));
    rooms[5]->addObject(monsters[3]);
    rooms[5]->setIsExit(true);
